...
@DisplayName("RemediationAvailableGuard")
class RemediationAvailableGuardTest {

    private final ObjectMapper mapper = new ObjectMapper();
    private final PipelineTopology topology = new PipelineTopology();
    private final RemediationAvailableGuard guard = new RemediationAvailableGuard(topology);
    ...
    @Test
    @DisplayName("REJECT at PRODUCT_REVIEW with zero attempts → true")
    void rejectWithAttemptsRemaining_returnsTrue() {
    ...
    @Test
    @DisplayName("REJECT at PRODUCT_REVIEW with exhausted attempts → false")
    void rejectWithExhaustedAttempts_returnsFalse() {
        vars.put(PipelineContextKeys.PENDING_STAGE, MidasState.PRODUCT_REVIEW);
        vars.put(PipelineContextKeys.LAST_VALIDATED_NODE, node("{\"verdict\":\"REJECT\"}"));
    ...
    @Test
    @DisplayName("REJECT at wrong stage → false")
    void rejectWrongStage_returnsFalse() {
