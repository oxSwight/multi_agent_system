...
public class RemediationAvailableGuard implements Guard<MidasState, MidasEvent> {
    ...
    public boolean evaluate(StateContext<MidasState, MidasEvent> context) {
        ...
        boolean available = topology.isProductReviewRemediationAvailable(midasContext);
        log.debug("[RemediationAvailableGuard] attempts={} available={}",
                midasContext.getProductReviewRemediationAttempts(), available);
        return available;
    }
